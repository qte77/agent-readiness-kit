...
- [docs/plans/0001-scan-engine.md](docs/plans/0001-scan-engine.md) — the single remaining-work
  table, opening with a `## Status` section for session-to-session onboarding (this project
